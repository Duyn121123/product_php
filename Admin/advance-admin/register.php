...
<body>
                            ...
                            <form role="form" method="POST">
                                 ...
                                 <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="" type="checkbox" name="bongda">Bongda
                                            <input class="" type="checkbox" name="bongda">Game
                                            <input class="" type="checkbox" name="bongda">Bongro
                                           
                                        </div>
                                        <div class="form-group">
                                            <label>Avatar</label>
                                            <input class="" type="file" name="txta" >
                                        ...
                                        <div class="form-group">
                                            <label>Địa chỉ</label>
                                            <input class="form-control" type="address" name="dc">
    ...
    if(isset($_POST['txtsub'])){// kiểm tra nút đăng ký đã ấn hay chưa
        $in_register=$get_data->insert_user($_POST['txtuser'],$_POST['txtpw'],$_POST['gender'],$_POST['bongda'],$_POST['txta'],$_POST['mail'],$_POST['dc']);
        if($in_register) echo"<script> alert('Thanh cong');
        </script>";
