                        ...
                        <div class="panel-body">
                            <form role="form" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="txtNP">
                                            
                                        </div>
                                        <div class="form-group">
                                            <label>NUMBER PRODUCT</label>
                                            <input class="form-control" type="text" name="txtNUP">
                                 ...
                                 <div class="form-group">
                                            ...
                                            <input class="form-control" type="file" name="txtPIP"></div>
                                <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" name="txtDP">
                                            
                                        </div>
                                        <div class="form-group">
                                            <label>PRICE PRODUCT</label>
                                            <input class="form-control" type="text" name="txtPP">
                                            ...
                                            <textarea class="form-control" rows="3" name="txtDEP"></textarea>
                                        </div>
...
<?php
    ...
    $insert=$get_data->insert_product($_POST['txtNP'],$_POST['txtNUP'],$_FILES['txtPIP']['name'],$_POST['txtCP'],$_POST['txtDP'],$_POST['txtPP'],$_POST['txtDEP']);
    if(isset($_POST['txtsub'])){// kiểm tra nút đăng ký đã ấn hay chưa
        move_uploaded_file($_FILES['txtPIP']['tmp_name'],'upload/'.$_FILES['txtPIP']['name']);
        
        if($insert) echo"<script> alert('Thanh cong');
        </script>";
